...
cookNcart = tkinter.Button(
    frame, text="CookNCart",bg='#F5B7B1', font=("Comic Sans MS", 25),borderwidth=1,relief='solid' )
No_of_people =  tkinter.Label(
    frame,text="No.of People             ",bg='#F5B7B1',font= ("Georgia",12))
No_of_people_entry= tkinter.Entry(
    frame,bg='#D2B4DE' ,font=("Georgia", 12))
Recipe_name =  tkinter.Label(
    frame,text="Recipe Name            ",bg='#F5B7B1',font= ("Georgia",12))
Recipe_name_entry= tkinter.Entry(
    frame,bg='#D2B4DE' ,font=("Georgia", 12))
List_of_ingredients=  tkinter.Label(
    frame,text=" List_of_ingredients",bg='#F5B7B1',font= ("Georgia",12))
