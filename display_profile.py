...
name_var = tkinter.StringVar(value=self.user.name)
...
email_var = tk.StringVar(value=self.user.email)
Email_entry = tkinter.Label(
    frame,bg='#D2B4DE' , font=("Georgia", 12), textvariable=email_var)
Password_label = tkinter.Label(
    frame, text="Password           ", bg='#AED6F1', font=("Georgia", 12))
password_var = tk.StringVar(value=self.user.password)
